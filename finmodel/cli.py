...
def main(argv=None):
    ...
    iiw = sp.add_parser("india-incentive-workbook", help="write the consolidated India state/central incentive + land-cost + 18-state matrix Excel workbook"); iiw.add_argument("output", help="output .xlsx path"); iiw.set_defaults(fn=cmd_india_incentive_workbook)
