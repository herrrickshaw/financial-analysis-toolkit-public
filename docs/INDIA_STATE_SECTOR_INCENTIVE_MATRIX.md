...
| Karnataka | Electronics / Auto Components | 3.00 cr/acre (**illustrative placeholder — no confirmed source**) | Karnataka Industrial Policy 2025-30 — Investment Promotion Subsidy, 25% of FCI in Zone 1 (confirmed rate; cap not confirmed) | — | 68.00 | 9.50 | 58.50 | 14.0% |
| Andhra Pradesh | General Manufacturing | 3.00 cr/acre (**illustrative placeholder — only expired 2011 figures found**) | AP Industrial Development Policy 4.0 — capital subsidy, 25% of FCI, capped ₹7cr (medium tier; both confirmed) | — | 68.00 | 7.00 | 61.00 | 10.3% |
| Madhya Pradesh | Food Processing | 3.00 cr/acre (**illustrative placeholder — no confirmed source**) | MP IPP 2025 — interest subsidy, 6% for 5 yrs (5–7% range, midpoint used; annual cap not confirmed) | — | 68.00 | 0.68 | 67.32 | 1.0% |
...
| **Total (12 states)** | | | | | **1,040.01** | **270.63** | **769.38** | **26.0%** |
...
"**Hardware Park**"; Tamil Nadu's from the "**Apparel Park**" plot within Irungattukottai) — a genuine
signal from the source data, not an assumption. Where no park name pointed to a specific sector (Uttar
Pradesh, Odisha, Andhra Pradesh, Punjab), "General Manufacturing / MSME" is used deliberately rather than
guessing a sector.
